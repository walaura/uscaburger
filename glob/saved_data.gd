...
static func _get_default_gfx_settings() -> Dictionary[Options, Array]:
	return {
		...
		Options.MSAA: [0, 0, 1],
		Options.FXAA: [0, 0, 0],
		Options.SHADOW_SIZE: [0, 2, 4],
		Options.SHADOW_FILTER: [2, 2, 4],
		Options.MESH_LOD: [0, 1, 3],
		Options.UI_SCALE: [1, 1, 1],
		Options.SCREEN_MODE: [0, 0, 0],
		Options.VSYNC: [0, 0, 0],
		Options.SCALING_ALGO: [0, 0, 0],
		Options.SCALING_SIZE: [1, 1, 1],
		Options.FSR_SHARPNESS: [0, 0, 0],
		Options.FPS_CAP: [30, 60, 60],
		Options.ENV_SDFGI: [0, 0, 0],
		Options.ENV_GLOW: [0, 1, 2],
		Options.ENV_SSAO: [0, 1, 3],
		Options.ENV_SS_REFLECTIONS: [0, 0, 0],
		Options.ENV_SSIL: [0, 1, 3],
		Options.ENV_FOG: [0, 1, 2],
	}
...
func get_gfx_setting(option: Options) -> Variant:
	return (
		...
		. get_value(
			"gfx",
			str(option),
			_get_default_gfx_settings()[option][1],
		)
	)
